	...
	<!-- banner start -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<center><img src="'.root.'assets/images/logomaros6.png"></center>
							<h1 class="text-center">BORIMASUNGGU</h1>
							<p class="lead text-center">Desa Borimasunggu adalah salah satu Desa yang berada di wilayah Kecamatan Maros Baru, Kabupaten Maros. Desa Borimasunggu terdiri dari 4 Dusun, yaitu Dusun Tekolabua, Salarang, Sungguminasa, dan Borongkalukua</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">Profil Desa <span>Borimasunggu</span></h1>
						<p class="lead text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta officia, aspernatur.</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-6">
								<img src="'.root.'assets/images/section-image-1.png" alt="">
								<div class="space"></div>
							</div>
							<div class="col-md-6">
		...
		<div class="section translucent-bg bg-image-1 blue">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="services"  class="text-center title">Informasi</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-sm-6">
						<div class="media">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="text-center">Lets Work Together!</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section">
			<div class="container">
				<h1 class="text-center title" id="portfolio">Galeri</h1>
					...
					<div class="col-md-12">
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-1.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-2.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-3.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-4.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-5.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-6.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-7.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-8.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-9.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-10.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-11.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="'.root.'assets/images/portfolio-12.jpg" alt="">
		...
		<div class="section translucent-bg bg-image-2 pb-clear">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="clients" class="title text-center">Potensi Desa</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="'.root.'assets/images/testimonial-1.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="'.root.'assets/images/testimonial-2.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="'.root.'assets/images/testimonial-3.png" alt="">
							</div>
							<div class="media-body">
		...
		<!-- section end 
			...
			<!-- section start -->
		<!-- ================ -->
		<div class="section translucent-bg bg-image-3 pb-clear">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="dokumen" class="title text-center">Dokumen</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
