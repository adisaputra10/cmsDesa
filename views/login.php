...
<head>
  ...
  <!-- start: Favicon -->
  <link rel="shortcut icon" href="'.root.'asset/img/favicon.ico">
  <!-- end: Favicon -->
    ...
    <div class="row-fluid">
      ...
      <div class="row-fluid">
        <div class="login-box">
          ...
          <form class="form-horizontal" form action="" method="POST">
            <fieldset>
              ...
              <div class="input-prepend" title="Username">
                ...
                <input class="input-large span10" input type="text" name="user" id="username"  placeholder="type username"/>
              </div>
              <div class="clearfix"></div>

              <div class="input-prepend" title="Password">
                <span class="add-on"><i class="halflings-icon lock"></i></span>
                <input class="input-large span10" type="password" name="password" id="password"  placeholder="type password"/>
              </div>
              <div class="clearfix"></div>
          ...
          <p>
            No problem, <a href="register.html">click here</a> to get a new password.
          </p>  
        </div><!--/span-->
      </div><!--/row-->
