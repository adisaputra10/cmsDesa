<?php
if(isset($method)):
	$aksi = adm."controllers/pengumuman_control.php?model=pengumuman&method=";
					...
					<div class="box-content">
						...
						foreach ($pengumuman as $a)
						{
						  echo'
							<tr>
								<td>'.$no++.'</td>
								<td class="center"><img width="30%" height="100%" src="'.root.'asset/pengumuman/'.$a['foto'].'"></td>
								<td class="center">'.$a['title'].'</td>
								<td class="center">'.substr($a['content'], 0, 420).'</td>
								
								<td class="center">
									<a class="btn btn-info" href="'.adm.'pengumuman/edit/'.$a['id'].'"> Edit
					  ...
					  if ($_SESSION['level'] == 'admin')
						{
							echo'
							<a href="'.adm.'pengumuman/add"><button type="submit" class="btn btn-success">Tambah Berita</button></a> 
							';
						}
					  echo'
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							   ...
							   <div class="controls">
								<img src="'.root.'asset/pengumuman/'.$a['foto'].'" width="30%" height="100%">
