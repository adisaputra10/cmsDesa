		...
		
						{
						  echo'
							<tr>
								...
								<td class="center">'.$a['file'].'</td>
								
								<td class="center">
									<a class="btn btn-info" href="'.adm.'dokumen/edit/'.$a['id'].'"> Edit
					  	...
					  	<a href="'.adm.'dokumen/add"><button type="submit" class="btn btn-success">Tambah Berita</button></a> 
						...
						<form class="form-horizontal" action="'.$aksi.'add" enctype="multipart/form-data" method="POST">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input class="input-file uniform_on" id="fileInput" type="file" name="file_doc">
							  </div>
							</div>          
		...
		foreach ($a as $a)
		{
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" <form action="'.$aksi.'edit" enctype="multipart/form-data" method="POST">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							   ...
							   <div class="controls">
								<a href="'.root.'asset/dokumen/'.$a['file'].'">Dokumen</a>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Isi Berita</label>
							  <div class="controls">
							  	<textarea name="deskripsi"                                                                                                                                                                                                                                                                                                                                                                        class="cleditor" id="textarea2" rows="3">'.$a['content'].'</textarea>
							  </div>
							</div>
							<div class="form-actions">
